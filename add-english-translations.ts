...
const verbConjugations: Record<string, Record<string, Record<string, string>>> = {
  bajar: {
...
// Simple replacement: add englishTranslation after conjugated
const pronouns = ['yo', 'tu', 'elEllaUsted', 'nosotros', 'vosotros', 'ellosEllasUstedes'];
const tenses = ['present', 'preterite', 'imperfect'];

Object.entries(verbConjugations).forEach(([verb, tenseData]) => {
  tenses.forEach(tense => {
    pronouns.forEach(pronoun => {
      const englishTranslation = tenseData[tense][pronoun];
      
      // Create a pattern to match: pronoun: { conjugated: '...', sampleSentence:
      // Replace with: pronoun: { conjugated: '...', englishTranslation: '...', sampleSentence:
...
console.log('All English translations have been added successfully!');
